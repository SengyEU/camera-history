...
require_once 'src/LoggerAwareInterface.php';
require_once 'src/LoggerAwareTrait.php';
require_once 'OpcodeTrait.php';
require_once 'Uri.php';
require_once 'src/NullLogger.php';
require_once 'source/ErrorHandler.php';
require_once 'Connection.php';
require_once 'Message/Factory.php';
